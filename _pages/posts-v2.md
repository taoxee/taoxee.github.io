...
/* dot-grid overlay */
.posts-v2-hero::before {
  content: '';
  position: absolute;
  inset: 0;
  background-image: radial-gradient(circle, rgba(88,166,255,0.18) 1px, transparent 1px);
  background-size: 28px 28px;
  pointer-events: none;
}
.posts-v2-hero__label {
...
/* blinking cursor */
.posts-v2-hero__title::after {
  content: '|';
  color: #58a6ff;
  font-weight: 300;
  animation: v2-cursor 1.1s step-end infinite;
  margin-left: 0.04em;
}
@keyframes v2-cursor {
  0%, 100% { opacity: 1; }
...
@media (prefers-reduced-motion: reduce) {
  .posts-v2-hero__title::after { animation: none; }
}
</style>

<div class="posts-v2-hero">
  <p class="posts-v2-hero__label">// latest_posts</p>
  <h1 class="posts-v2-hero__title" data-translate="Posts & Thoughts">Posts & Thoughts</h1>
  <p class="posts-v2-hero__subtitle" data-translate="posts_hero_subtitle">Sharing insights, experiences, and discoveries</p>
  <div class="posts-v2-counter" id="posts-v2-counter">── loading ──</div>
  <div class="posts-v2-pills">
    <span class="posts-v2-pill">
      <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
      Tech
    </span>
    <span class="posts-v2-pill">
    ...
    <span class="posts-v2-pill">
      <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
      Learning
    </span>
    <span class="posts-v2-pill">
      <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
      Career
    </span>
  </div>
</div>
...
<div id="posts-v2-container" class="reveal-stagger" style="margin: 2rem 0;">
  {% if has_social %}
...
<div class="about-card reveal" style="text-align: center; margin: 3rem 0;">
  ...
  <a href="/contact/" style="display: inline-block; background: linear-gradient(135deg, #58a6ff, #3fb950) !important; color: white !important; padding: 0.75rem 1.5rem; border-radius: 20px; text-decoration: none; font-weight: 600; font-size: 1rem; transition: all 0.3s ease; box-shadow: 0 4px 12px rgba(88,166,255,0.3);" onmouseover="this.style.opacity='0.9'; this.style.transform='translateY(-2px)'" onmouseout="this.style.opacity='1'; this.style.transform='translateY(0)'" data-translate="Suggest a Topic">
    Suggest a Topic
  </a>
</div>
{% endunless %}
...
<h2 class="reveal" style="font-size: 1.75rem; font-weight: 600; color: #2d3748; margin: 4rem 0 1.5rem 0; text-align: center;">
  <span style="background: linear-gradient(135deg, #58a6ff, #3fb950); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;" data-translate="Categories">Browse by Topic</span>
</h2>

<div class="reveal" style="display: flex; flex-wrap: wrap; gap: 0.75rem; justify-content: center; margin-bottom: 4rem;">
...
<script>
/* Animated counter: waits briefly for async post injection, then ticks up to total */
(function () {
  var el = document.getElementById('posts-v2-counter');
  if (!el) return;
  function countAndAnimate() {
    var cards = document.querySelectorAll('#posts-v2-container > *');
    var total = cards.length;
    if (total === 0) { el.textContent = '── 0 posts ──'; return; }
    var n = 0;
    var step = Math.max(1, Math.ceil(total / 18));
  ...
  setTimeout(countAndAnimate, 350);
})();
</script>
